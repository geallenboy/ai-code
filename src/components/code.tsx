...
export function Code({ files }: { files: { name: string; content: string }[] }) {
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center px-2 pt-1 gap-2">
        <div className="flex flex-1 gap-2 overflow-x-auto">
          {files.map((file) => (
            <div
              className={`flex gap-2 select-none cursor-pointer text-sm text-muted-foreground px-2 py-1 rounded-md hover:bg-muted border ${
